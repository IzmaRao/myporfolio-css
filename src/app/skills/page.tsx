    ...
    return (
      ...
      <div className="skill-one-div">
        <div className="skill-two-div">
          <div>
            <h1 className="skill-h-one">MY SKILLS</h1>
            <h1 className="skill-h-two">My Expertise</h1>


            <div className="skill-div-three">
              <div className="skill-div-four">
                <span className="skill-span-one">HTML</span>
            ...
            <div className="skill-div-three">
              <div className="skill-div-four">
                <span className="skill-span-one">CSS</span>
            ...
            <div className="skill-div-three">
              <div className="skill-div-four">
                <span className="skill-span-one">JavaScript</span>
            ...
            <div className="skill-div-three">
              <div className="skill-div-four">
                <span className="skill-span-one">typescript</span>
            ...
            <div className="skill-div-three">
              <div className="skill-div-four">
                <span className="skill-span-one">Tailwind Css</span>
